...
const translations = {
    zh: {
        ...
        'features_shipping_text': '订单满3000₽免运费',
    ...
    en: {
        ...
        'features_shipping_text': 'Free shipping on orders over 3000₽',
    ...
    ru: {
        ...
        'features_shipping_text': 'Бесплатная доставка при заказе от 3000₽',
